...
Applying this repeatedly to triangles formed by all triplets of consecutive vertices gives Equation~\eqref{eqn:polygon-condn}. Finally, note that all the two-dimensional facets of the Delaunay triangulations $D_{\phi}$ and $D_{\phi'}$ are connected via shared edges. Thus, joining the Equation~\eqref{eqn:polygon-condn} of all polygons via shared edges, we get that for some $\lambda > 0$,
$$
\|\phi(\sigma)-\phi(\sigma')\| = \lambda \cdot \|\phi'(\sigma)-\phi'(\sigma')\|,
$$
